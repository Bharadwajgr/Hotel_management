...
function cincheck()
{
	...
	{
		cin.style.background = 'Yellow';
		error += "You didnt enter the checkin date.\n";
	}
	else if(cin.value.search(jcin)==-1)
	{
		cin.style.background = 'Yellow';
		error += "Please Enter proper checkin date.\n";
	}
...
function coutcheck()
{
	...
	{
		cout.style.background = 'Yellow';
		error += "You didnt enter the checkout date.\n";
	}
	else if(cout.value.search(jcout)==-1)
	{
		cout.style.background = 'Yellow';
		error += "Please Enter proper checkout date.\n";
	}
